      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right">
            <a href="{{ url('admin/student/add')}}" class="btn btn-success"> + Add New Students</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="justify-content-center">
                        <a href="{{ route('updateStudent', ['id' => $value->id]) }}" class="btn btn-primary mr-2" >
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <form action="{{ route('deleteStudent', ['id' => $value->id]) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
